...
/* 
 * las tablas EMPLEADOS y DEPARTAMENTOS tiene el formato anterior
 * sin ELIMINADO
 * 
 */
package Formularios;
...
public class GestionEmpleados_Hiber extends javax.swing.JFrame {
    ...
    private void txtEmp_noFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtEmp_noFocusLost
        try {
            if (txtEmp_no.getText().isEmpty()) {
                ...
                //Integer v = Integer.parseInt(txtEmp_no.getText());
                //Short vemp_no = v.shortValue();
                Short vemp_no=Short.parseShort(txtEmp_no.getText());
                sesion = instancia.openSession();
                e = (Empleados) sesion.get(Empleados.class, vemp_no);
                if (e != null) {
                    ActivarCampos();
                    VisualizarCampos(e);
                } else {
        ...
        if (txtEmp_no.getText().isEmpty()) {
            ...
            try {
                ...
                if ("".equals(txtSalario.getText())) {
                    System.out.println("asigna cero a salario");
                    e.setSalario(BigDecimal.ZERO);
                } else {
                    System.out.println("NO asigna cero a salario");
                    e.setSalario(new BigDecimal(txtSalario.getText()));
                }
                if ("".equals(txtComision.getText())) {
                    System.out.println("asigna cero a COMISION");
                    e.setComision(BigDecimal.ZERO);
                } else {
                    System.out.println("NO asigna cero a COMISION");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            ...
            Integer vemp_no = Integer.parseInt(txtEmp_no.getText());
            short emp_no_ant = vemp_no.shortValue();
            Empleados em = (Empleados) sesion.get(Empleados.class, (short) emp_no_ant);
            if (em != null) {
                sesion.delete(em);
                int respuesta = JOptionPane.showConfirmDialog(null, "Desea Eliminar el Cliente?");
                if (respuesta == JOptionPane.YES_OPTION) {
                    transaccion.commit();
                } else {
                    transaccion.rollback();
    ...
    private boolean ExisteEmpleado(short Emp_no) {
        ...
        Empleados em = (Empleados) sesion.get(Empleados.class, Emp_no);
