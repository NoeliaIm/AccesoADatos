 ...
 */
package ad_act7_gestionclientes;
...
public class AD_Act7_gestionclientes extends javax.swing.JFrame {
    ...
    public AD_Act7_gestionclientes() {
        ...
        aleatorio=new RAF(201, FICHERO, datos);
    ...
    private void botonAnadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAnadirActionPerformed
        ...
        if(MiSwing.comprobarVacios(campos)){
            ...
            if(aleatorio.comprobarIDExistente(Integer.parseInt(campoIDCliente.getText()))/*comprobarCliente()*/){
                JOptionPane.showMessageDialog(this, "El cliente existe");
            }else{
                if(Numeros.comprobarDNI(campoDNI.getText())){
                   /*anadirCliente();*/
                   aleatorio.anadir(Integer.parseInt(campoIDCliente.getText()), MiSwing.obtenerValoresDe(campos));
    ...
    private void campoDescuentoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_campoDescuentoKeyTyped
        MiSwing.escribirSoloDoubles(campoDescuento,evt,lbl, 2,2);
        ...
        if(!MiSwing.comprobarVacio(campoIDCliente, "El campo ID Cliente no puede esta vacio, inserta otro")){
            if(!aleatorio.comprobarIDExistente(Integer.parseInt(campoIDCliente.getText()))/*!comprobarCliente()*/){
               JOptionPane.showMessageDialog(this, "El Cliente no existe", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                if(aleatorio.comprobarBorrado(Integer.parseInt(campoIDCliente.getText()))/*clienteBorrado()*/){
                    JOptionPane.showMessageDialog(this, "Este ha sido borrado", "Error", JOptionPane.ERROR_MESSAGE);
                }else{
                    //buscarCliente();
                    String[] datos=aleatorio.devolverDatos(Integer.parseInt(campoIDCliente.getText()));
                    MiSwing.introducirValoresDe(campos, datos);
    ...
    private void botonBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBorrarActionPerformed
        ...
        if(seleccion==JOptionPane.YES_OPTION){
            //borrarCliente();
            aleatorio.borrar(Integer.parseInt(campoIDCliente.getText()));
