...
public class Array {
    ...
    /**
     * Indica si los números de un array son capicua, es decir, que es el mismo número si se lee por el principio y por el final
    ...
    /**
     * Redimensiona un array de números dando una nueva logitud, los datos posteriores se borraran
    ...
    /**
     * Redimensiona un array de cadenas dando una nueva logitud, los datos posteriores se borraran
     * @param array Array que queremos redimensionar
     * @param nuevaLongitud La longitud que tendrá el nuevo array
     * @return Devuelve un nuevo array redimensionado
     */
    ...
    /**
     * Redimensiona un array de doubles dando una nueva logitud, los datos posteriores se borraran
     * @param array Array que queremos redimensionar
     * @param nuevaLongitud La longitud que tendrá el nuevo array
     * @return Devuelve un nuevo array redimensionado
     */
