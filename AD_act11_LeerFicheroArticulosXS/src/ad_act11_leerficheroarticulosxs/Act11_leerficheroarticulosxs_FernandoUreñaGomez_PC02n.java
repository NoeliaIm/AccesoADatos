 ...
 * @author Alumno
 */
public class Act11_leerficheroarticulosxs_FernandoUreñaGomez_PC02n extends javax.swing.JFrame {

    /**
     * Creates new form Act5_GestionArticulos_FernandoUreñaGomez_PC02n
     */
    
    public Act11_leerficheroarticulosxs_FernandoUreñaGomez_PC02n() {
        ...
        xml=new CXStream<>("Articulos", "Articulo", "ad_act11_leerficheroarticulosxs.Articulo");
...
//       Act11_CrearXMLArticulosXS_FernandoUrenaGomez_PC02 fichero=new Act11_CrearXMLArticulosXS_FernandoUrenaGomez_PC02();
//       fichero.creaFichero("articulos.xml");
//       
       xml.creaFichero(FICHEROXML.getName(), FICHERO.getName());
        
       if (FICHEROXML.exists()){
            JOptionPane.showMessageDialog(this, "Fichero XML actualizado");
        }else{
            JOptionPane.showMessageDialog(this, "Fichero XML creado");
        }
...
//        Act11_LeerXMLArticulosXS_FernandoUrenaGomez_PC02 fichero = new Act11_LeerXMLArticulosXS_FernandoUrenaGomez_PC02(areaTexto);
//        
//        fichero.mostrarFichero(FICHEROXML.getName());
        
        
        xml.mostrarFicheroTextArea(areaTexto, FICHEROXML.getName());
        xml.mostrarFicheroTexto(new File("prueba.txt"), FICHEROXML.getName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Act11_leerficheroarticulosxs_FernandoUreñaGomez_PC02n().setVisible(true);
            }
        });
    }
