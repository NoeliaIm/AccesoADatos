 ...
 */
package ad_act_9_leerarticulosxlm_fernandourenagomez_pc02;
...
public class Act9_GestionArticulos_FernandoUreñaGomez_PC02n extends javax.swing.JFrame {
    ...
    public void leerFicheroXML(){
        ...
        String[] nombreNodos={"id", "nombre", "precio", "cantAlmacen"};

        String contenido=xml.leerFichero(nombreNodos, "articulo");
        
        areaTexto.setText(contenido);
        
        System.out.println(xml.numeroElementos(xml.obtenerRaiz(), "articulo"));
...
//        }
    ...
    private void campoPrecioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_campoPrecioKeyTyped
        ...
        //wing.escribirSoloDoubles(evt,errorLimitePrecioLabel);
